    ...
    <div className="min-h-screen flex flex-col bg-footbai-background">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-4 py-12 text-center">
        <h1 className="text-4xl sm:text-6xl font-bold text-white mb-4">
          <span className="text-footbai-accent">FOOTB</span>-AI
        </h1>
        <p className="text-xl text-gray-300 mb-8 max-w-2xl">
          Create your football club, customize your team's attributes, and simulate matches in this interactive football simulation game.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl w-full">
          <Card className="bg-footbai-container border-footbai-header hover:border-footbai-accent transition-colors">
            <CardContent className="p-6 flex flex-col items-center text-center">
              ...
              <p className="text-gray-400 text-sm">Design your team logo and customize club attributes to match your strategy.</p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-footbai-container border-footbai-header hover:border-footbai-accent transition-colors">
            <CardContent className="p-6 flex flex-col items-center text-center">
              ...
              <p className="text-gray-400 text-sm">Choose tactics and formations to get the most out of your team's strengths.</p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-footbai-container border-footbai-header hover:border-footbai-accent transition-colors">
            <CardContent className="p-6 flex flex-col items-center text-center">
              ...
              <p className="text-gray-400 text-sm">Experience dynamic match simulations with real-time events and statistics.</p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-footbai-container border-footbai-header hover:border-footbai-accent transition-colors">
            <CardContent className="p-6 flex flex-col items-center text-center">
              ...
              <p className="text-gray-400 text-sm">Win matches to earn points and upgrade your team's attributes.</p>
            </CardContent>
          </Card>
        </div>
      </div>
